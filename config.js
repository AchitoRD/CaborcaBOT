    ...
    shop: {
        items: [
            ...
            { id: 'chevlon_antelope_1994', name: 'Chevlon Antelope 1994 👴🚗', price: 18000, category: 'Vehículos Civiles', description: 'Un clásico confiable para el día a día. ¡Ideal para empezar!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_antelope.png' },
            { id: 'ford_raptor_2020', name: 'Ford Raptor 2020 🚚💪', price: 55000, category: 'Vehículos Civiles', description: 'Potente camioneta para el desierto y el trabajo pesado. ¡Nada la detiene!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_raptor.png' },
            { id: 'dodge_charger_srt_2022', name: 'Dodge Charger SRT 2022 🏎️💨', price: 85000, category: 'Vehículos Civiles', description: 'Deportivo muscular con gran velocidad y presencia. ¡Siente la adrenalina!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_charger.png' },
            { id: 'honda_civic_hatchback_2021', name: 'Honda Civic Hatchback 2021 Hatchback', price: 28000, category: 'Vehículos Civiles', description: 'Compacto, eficiente y ágil para la ciudad. ¡Perfecto para moverte sin líos!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_civic.png' },
            { id: 'gmc_sierra_3500hd', name: 'GMC Sierra 3500HD 🚜🏗️', price: 65000, category: 'Vehículos Civiles', description: 'Camioneta robusta para las tareas más exigentes. ¡Lleva lo que necesites!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_sierra.png' },
            { id: 'tesla_model_x_2023', name: 'Tesla Model X 2023 ⚡🚘', price: 110000, category: 'Vehículos Civiles', description: 'SUV eléctrico de lujo con tecnología avanzada. ¡El futuro está aquí!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_teslax.png' },
            { id: 'strugatti_ettore_2020', name: 'Strugatti Ettore 2020 🌟🏎️', price: 150000, category: 'Vehículos Civiles', description: 'Exótico superdeportivo, máximo lujo y velocidad. ¡Para los más exigentes!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_strugatti.png' },
            { id: 'toyota_camry_2019', name: 'Toyota Camry 2019 👨‍👩‍👧‍👦 Sedán', price: 32000, category: 'Vehículos Civiles', description: 'Sedán confiable y popular. ¡Un compañero fiel en la carretera!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_camry.png' },
            { id: 'jeep_wrangler_unlimited_2021', name: 'Jeep Wrangler Unlimited 2021 ⛰️🚗', price: 45000, category: 'Vehículos Civiles', description: 'Todoterreno icónico para aventuras off-road. ¡Explora sin límites!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_wrangler.png' },
            { id: 'porsche_911_carrera_2023', name: 'Porsche 911 Carrera 2023 🏁🔥', price: 130000, category: 'Vehículos Civiles', description: 'Deportivo legendario con rendimiento y estilo inigualables. ¡Pura velocidad!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_porsche.png' },
            { id: 'mercedes_benz_c_class_2022', name: 'Mercedes-Benz C-Class 2022 💼🚘', price: 58000, category: 'Vehículos Civiles', description: 'Sedán de lujo con elegancia y tecnología alemana. ¡Viaja con confort!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_mercedesc.png' },
            { id: 'bmw_x5_2023', name: 'BMW X5 2023 🏞️SUV', price: 70000, category: 'Vehículos Civiles', description: 'SUV de lujo deportivo y versátil. ¡Espacio y potencia para toda la familia!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_bmwx5.png' },
            { id: 'audi_a4_2021', name: 'Audi A4 2021 ✒️🚘', price: 42000, category: 'Vehículos Civiles', description: 'Sedán premium con diseño sofisticado y gran manejo. ¡Disfruta cada viaje!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_audia4.png' },
            { id: 'volkswagen_golf_gti_2022', name: 'Volkswagen Golf GTI 2022 🏎️💨', price: 35000, category: 'Vehículos Civiles', description: 'Hatchback deportivo y ágil. ¡Diversión garantizada en cada curva!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_golfgti.png' },
            { id: 'subaru_wrx_sti_2021', name: 'Subaru WRX STI 2021 랠리🏎️', price: 40000, category: 'Vehículos Civiles', description: 'Rally car de calle con tracción total. ¡Control total en cualquier terreno!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_sti.png' },
            { id: 'ford_mustang_gt_2022', name: 'Ford Mustang GT 2022 🐎🔥', price: 50000, category: 'Vehículos Civiles', description: 'Clásico muscle car americano con un potente motor V8. ¡El rugido del asfalto!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_mustang.png' },
            { id: 'chevrolet_camaro_ss_2022', name: 'Chevrolet Camaro SS 2022 🦁🏎️', price: 52000, category: 'Vehículos Civiles', description: 'Icono del muscle car, rendimiento y diseño agresivo. ¡Dominio en la calle!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_camaross.png' },
            { id: 'nissan_gtr_r35_2023', name: 'Nissan GT-R R35 2023 🐉🏎️', price: 120000, category: 'Vehículos Civiles', description: 'Superdeportivo japonés con tecnología de vanguardia y velocidad extrema. ¡Godzilla!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_gtr.png' },
            { id: 'mazda_mx5_miata_2022', name: 'Mazda MX-5 Miata 2022 🌸 convertible', price: 30000, category: 'Vehículos Civiles', description: 'Roadster ligero y divertido de conducir. ¡Perfecto para sentir el viento!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_miata.png' },
            { id: 'hyundai_elantra_n_2023', name: 'Hyundai Elantra N 2023 🏁💨', price: 33000, category: 'Vehículos Civiles', description: 'Sedán deportivo sorprendentemente potente y ágil. ¡No subestimes su tamaño!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_elantran.png' },
            { id: 'kia_stinger_gt_2022', name: 'Kia Stinger GT 2022 🐅💨', price: 48000, category: 'Vehículos Civiles', description: 'Sedán gran turismo con diseño elegante y motor potente. ¡Estilo y velocidad!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_stinger.png' },
            { id: 'polaris_slingshot', name: 'Polaris Slingshot 🏍️💨', price: 35000, category: 'Vehículos Civiles', description: 'Vehículo de tres ruedas para una experiencia de conducción única. ¡Atrévete!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_slingshot.png' },
            { id: 'can_am_ryker', name: 'Can-Am Ryker 🛵💨', price: 15000, category: 'Vehículos Civiles', description: 'Motocicleta de tres ruedas, ligera y fácil de manejar. ¡Libertad en dos ruedas (y una más)!', roleId: 'ID_ROL_CIVIL_VEHICLE', imageUrl: 'https://i.imgur.com/example_ryker.png' },
            // Agrega más vehículos civiles aquí, hasta completar tu lista de 74+
            // ... (¡asegúrate de rellenar los roleId y imageUrl con valores reales o placeholders!) ...
            ...
            // --- LICENCIAS ---
            { id: 'licencia_conduccion_b', name: 'Licencia de Conducción Tipo B 🚗📜', price: 1000, category: 'Licencias', description: 'Permite conducir vehículos civiles básicos (autos, camionetas). ¡A rodar!', roleId: 'ID_ROL_CIVIL_LICENSE_B', imageUrl: 'https://i.imgur.com/example_licenseb.png' },
            { id: 'licencia_conduccion_c', name: 'Licencia de Conducción Tipo C 🚛📜', price: 2500, category: 'Licencias', description: 'Permite conducir vehículos comerciales y pesados (camiones, buses). ¡Para los más grandes!', roleId: 'ID_ROL_CIVIL_LICENSE_C', imageUrl: 'https://i.imgur.com/example_licensec.png' },
    ...
    ticketCategoryChannelId: null, // ID de tu canal de categoría de tickets. Ejemplo: '123456789012345678'
